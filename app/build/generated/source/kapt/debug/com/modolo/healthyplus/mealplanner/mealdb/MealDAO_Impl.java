...
public final class MealDAO_Impl implements MealDAO {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateMeal;
  ...
  public MealDAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMeal = new EntityInsertionAdapter<Meal>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `meals` (`id`,`name`,`foodList`,`date`,`ispreset`,`isdone`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Meal value) {
        ...
        if (value.getFoodList() == null) {
          stmt.bindNull(3);
        } else {
          stmt.bindString(3, value.getFoodList());
        }
    ...
    this.__preparedStmtOfUpdateMeal = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE meals SET name=?, foodList=?, date=?, ispreset=?, isdone=? WHERE id=?";
        return _query;
      }
    };
  ...
  @Override
  public Object insertMeal(final Meal meal, final Continuation<? super Unit> p1) {
  ...
  @Override
  public Object deleteMeal(final Meal meal, final Continuation<? super Unit> p1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
  ...
  @Override
  public Object updateMeal(final int id, final String name, final String foodList,
      final String data, final boolean ispreset, final boolean isdone,
      final Continuation<? super Unit> p6) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateMeal.acquire();
        int _argIndex = 1;
        if (name == null) {
        ...
        if (foodList == null) {
          ...
          _stmt.bindString(_argIndex, foodList);
        }
        _argIndex = 3;
        if (data == null) {
          _stmt.bindNull(_argIndex);
        ...
        try {
          ...
          __db.endTransaction();
          __preparedStmtOfUpdateMeal.release(_stmt);
        }
      }
    }, p6);
  }
  ...
  @Override
  public Object getAll(final Continuation<? super List<Meal>> p0) {
    final String _sql = "SELECT * FROM meals ORDER BY date";
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<Meal>>() {
      ...
      public List<Meal> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfFoodList = CursorUtil.getColumnIndexOrThrow(_cursor, "foodList");
          ...
          while(_cursor.moveToNext()) {
            ...
            final String _tmpFoodList;
            if (_cursor.isNull(_cursorIndexOfFoodList)) {
              _tmpFoodList = null;
            } else {
              _tmpFoodList = _cursor.getString(_cursorIndexOfFoodList);
            }
            ...
            _tmpIsdone = _tmp_1 != 0;
            _item = new Meal(_tmpId,_tmpName,_tmpFoodList,_tmpDate,_tmpIspreset,_tmpIsdone);
            _result.add(_item);
          }
          return _result;
        } finally {
